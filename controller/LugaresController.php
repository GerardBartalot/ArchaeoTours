...
class LugaresController
{
    ...
    public function updatePlaceAjax(): void
    {
        try {
            ...
            // Read and decodificate JSON data send by AJAX
            ...
            $video2 = $data['video2'];
            $imagen = $data['imagen'];
            $imagen_secundaria1 = $data['imagen_secundaria1'];
            $imagen_secundaria2 = $data['imagen_secundaria2'];
            $imagen_secundaria3 = $data['imagen_secundaria3'];
            ...
            $stmt->bindParam(1, $localizacion);
            $stmt->bindParam(2, $tipologia);
            $stmt->bindParam(3, $periodo);
            $stmt->bindParam(4, $subperiodo);
            $stmt->bindParam(5, $descripcion);
            $stmt->bindParam(6, $link1);
            $stmt->bindParam(7, $link2);
            $stmt->bindParam(8, $link3);
            $stmt->bindParam(9, $video1);
            $stmt->bindParam(10, $video2);
            $stmt->bindParam(11, $imagen);
            $stmt->bindParam(12, $imagen_secundaria1);
            $stmt->bindParam(13, $imagen_secundaria2);
            $stmt->bindParam(14, $imagen_secundaria3);
            $stmt->bindParam(15, $nombre);
